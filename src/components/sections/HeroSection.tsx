...
export const HeroSection = ({ settings }: HeroSectionProps) => {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 gpu-boost">
            ...
            {/* Full High-Performance Hero Background */}
            <div className="absolute inset-0 z-0 bg-slate-950">
                <Image
                    src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=2021&auto=format&fit=crop"
                    alt="Travel Background"
                    fill
                    className="object-cover object-[65%_center] md:object-center scale-110 md:scale-100 transition-opacity duration-700"
                    sizes="100vw"
                    priority
                />
                {/* Multi-stage Premium Overlay */}
